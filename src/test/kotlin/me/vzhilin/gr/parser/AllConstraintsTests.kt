...
class AllConstraintsTests {
    private fun sampleCells1(): Triple<Grammar, String, Cells> {
        ...
        with (cells) {
            setSymbolId(6, g,    "T",    "T",    "T",    "T",    "T",    "T",    "T",    "T")
            setSymbolId(5, g,  "APP",  "APP",  "APP",  "APP",  "APP",  "APP",  "APP",  "APP")
            setSymbolId(4, g,    "T",    "T",    "T",    "T",    "T",    "T",    "T",    "T")
            setSymbolId(3, g, "ABST", "ABST", "ABST", "ABST", "ABST", "ABST", "ABST", "ABST")
            setSymbolId(2, g,    "λ",    "V",    ".",    "T",    "λ",    "V",    ".",    "T")
            setSymbolId(1, g,    "λ",    "x",    ".",    "V",    "λ",    "y",    ".",    "V")
            setSymbolId(0, g,    "λ",    "x",    ".",    "x",    "λ",    "y",    ".",    "y")
    ...
    private fun sampleCells2(): Triple<Grammar, String, Cells> {
        ...
        val cells = Cells(5, 9)
        with(cells) {
            setSymbolId(4, grammar, "T", "T", "T", "T", "T", "T", "T", "T", "T")
            setSymbolId(3, grammar, "ABST", "ABST", "ABST", "ABST", "ABST", "ABST", "ABST", "ABST", "ABST")
            setSymbolId(2, grammar, "λ", "V", ".", "T", "λ", "V", ".", "T", "T")
            setSymbolId(1, grammar, "λ", "x", ".", "V", "λ", "y", ".", "V", "V")
            setSymbolId(0, grammar, "λ", "x", ".", "x", "λ", "y", ".", "y", "y")
    ...
    private fun sampleCells3(): Triple<Grammar, String, Cells> {
        ...
        val cells = Cells(8, 9)
        with(cells) {
            setSymbolId(7, grammar, "T", "T", "T", "T", "T", "T", "T", "T", "T")
            setSymbolId(6, grammar, "ABST", "ABST", "ABST", "ABST", "ABST", "ABST", "ABST", "ABST", "ABST")
            setSymbolId(5, grammar, "λ", "V", ".", "T", "T", "T", "T", "T", "T")
            setSymbolId(4, grammar, "λ", "x", ".", "T", "T", "T", "T", "T", "T")
            setSymbolId(3, grammar, "λ", "x", ".", "V", "ABST", "ABST", "ABST", "ABST", "V")
            setSymbolId(2, grammar, "λ", "x", ".", "V", "λ", "V", ".", "T", "y")
            setSymbolId(1, grammar, "λ", "x", ".", "x", "λ", "y", ".", "V", "y")
            setSymbolId(0, grammar, "λ", "x", ".", "x", "λ", "y", ".", "y", "y")
    ...
    private fun sampleCells4(): Triple<Grammar, String, Cells> {
        ...
        val cells = Cells(5, 2)
        with (cells) {
            setSymbolId(4, grammar, "T", "T")
            setSymbolId(3, grammar, "APP", "APP")
            setSymbolId(2, grammar, "T", "T")
            setSymbolId(1, grammar, "V", "V")
            setSymbolId(0, grammar, "y", "x")
